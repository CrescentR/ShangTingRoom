package com.room.ShangTingRoom.web.admin.controller.system;
...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        ...
        IPage<SystemUserItemVo> systemUserIPage = systemUserService.pageSystemUserByQuery(page,queryVo);
        return Result.ok(systemUserIPage);
    }
